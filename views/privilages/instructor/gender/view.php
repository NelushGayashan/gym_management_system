<?php require_once('C:/xampp/htdocs/test/controllers/operations_gender.php'); 
...
<!-- Header -->
  <div class="w3-container  w3-text-black card recent-sales" style="margin-top:50px ; margin-bottom:20px " id="showcase" >
    <h1 class="w3-xxlarge "><b>View Gender Details</b></h1>
...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/admin/expenses_income_management.php">Expense And Income Management</a></li>
            ...
            <li class="breadcrumb-item active">View Gender Details</a></li>
    ...
    <!-- The Modal -->
                ...
                <div class="modal-content ">
                    <span onclick="document.getElementById('add').style.display='none'"  style="margin-left:880px ; margin-bottom:-40px">&times;</span>
                     <span onclick="document.getElementById('add').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                        <?php require_once('C:/xampp/htdocs/test/views/privilages/admin/gender/index.php'); ?>
                <script>
		...
		$.ajax({
			data: data,
			type: "post",
			url: "localhost/test/controllers/operations_gender.php/Store_Record()",
    ...
    <script>
      ...
      <td align = "center">    
        ...
        $(document).ready(function () {
            ...
            $('.viewbtn').on('click', function () {
                ...
                $.ajax({ //create an ajax request to display.php
                    type: "POST",
                    url: "localhost/test/controllers/operations_gender.php/view_record()",
       ...
       <button id="editbtn" onclick="document.getElementById('edit<?php echo $data['id'] ?>').style.display='block'" class="btn btn-warning" style="  margin-left:0px ; margin-top:10px ; margin-bottom:10px "><span class="glyphicon glyphicon-pencil"></span> Edit</button>
        ...
        <div align="left" class="row col-lg-12 m-auto card mt-5 card-body w3-text-black" style="margin-left:0px ; margin-top:10px ; margin-bottom:0px">
                        ...
                        <?php $db->Store_Record(); ?>
                            ...
                            <form method="POST" action = "edit.php?U_ID=<?php echo $data['id'] ?>" align="left">
                                ...
                                <label for="Date" class="col-sm-4 col-form-label">Gender</label>
                                <div class="col-sm-8">
                                <input style="margin-bottom:30px" type="text" name="gender" placeholder="Date" class="form-control mb-2" required value="<?php echo $data['gender']; ?>" >
                                </div>
                                </div>
       ...
       <!-- End page content -->
        ...
        $(document).ready(function () {
            ...
            $('.editbtn').on('click', function () {
                ...
                $('#edit<?php echo $data['id'] ?>').modal('show');
