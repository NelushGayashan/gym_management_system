...
<div class="pagetitle col-lg-12"  style="margin-top:10px ; margin-bottom:-50px; margin-left:0px ">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/instructor/leave_details/view.php">View Leave Details</a></li>
        ...
        <div class="row col-lg-12 m-auto card mt-5 card-body w3-text-black" style="margin-left:0px ; margin-top:10px ; margin-bottom:0px">
                        ...
                        <?php $db->Store_Record(); ?>
                             ...
                             <form method="POST" id="user_form">
                                ...
                                $sql = "SELECT * FROM staff s, useraccount u
                                        where u.id = s.useraccount_id and u.id = '".$_SESSION['id']."' ";
