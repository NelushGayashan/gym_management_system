...
<head>
    ...
    <title>Add Designation Details</title>
</head>
<!-- Header -->
  <div class="w3-container" style="margin-top:80px ; margin-bottom:80px" id="showcase">
    <h1 class="w3-xxxlarge w3-text-black"><b>Add Designation Details</b></h1>
    <hr style="width:50px;border:5px solid green" class="w3-round">
        ...
        <div class="row col-lg-6 m-auto card mt-5 card-body w3-text-black" style="margin-left:100px ; margin-top:0px ; margin-bottom:100px">
				...
				<input style="margin-bottom:30px" type="hidden" name="id" placeholder="ID" class="form-control mb-2" required>
                                
                                <label class="card-footer" style="margin-bottom:10px"> Designation </label>
                                <input style="margin-bottom:30px" type="text" name="name" placeholder="Designation Name" class="form-control mb-2" required>
