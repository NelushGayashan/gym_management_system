...
<div class="pagetitle">
    ...
    <!-- The Modal -->
            ...
            <!-- Modal content -->
                <div class="modal-content ">
                    <span onclick="document.getElementById('add').style.display='none'"  style="margin-left:880px ; margin-bottom:-40px">&times;</span>
                     <span onclick="document.getElementById('add').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                        <?php require_once('C:/xampp/htdocs/test/views/privilages/admin/attendance/index.php'); ?>
                <script>
                ...
                if (event.target == modal) {
                 modal.style.display = "none";
                                ...
                                <td style="width: 10%" > Staff Designation ID </td>
                                <td style="width: 10%" > Date </td>
                                <td style="width: 10%" > In Time</td>
				<td style="width: 10%" >Out Time </td>
                                <td style="width: 10%" >Total Working Hours </td>
                            ...
                            <tr>
                                <?php while($data = mysqli_fetch_assoc($result)) {?>
                                    ...
                                    <td ><?php echo $data['staff_designation_id'] ?></td>
       ...
       <!-- Trigger/Open The Modal -->
       <button onclick="document.getElementById('view<?php echo $data['id'] ?>').style.display='block'" class="btn btn-info" style="  margin-left:0px ; margin-top:10px ; margin-bottom:10px "><span class="glyphicon glyphicon-list-alt"></span> View </button>
       ...
       <li class="breadcrumb-item bi bi-house-door"><a href="http://localhost/test/views/common/homepage.php">Home</a></li>
       <li class="breadcrumb-item"><a href="http://localhost/test/views/privilages/admin/dashboard.php">Dashboard</a></li>
       <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/admin/expenses_income_management.php">Staff Management</a></li>
       <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/admin/income/view.php">View Leave Details</a></li>
       ...
       <label for="Expenses details" class="col-sm-2 col-form-label">Attendance ID</label>
       <div class="col-sm-3">
       ...
       <label for="Expenses details" class="col-sm-3 col-form-label">Designation ID</label>
       <div class="col-sm-3">
       <input style="margin-bottom:30px" type="text" name="details" placeholder="Expenses details" class="form-control mb-2" required value="<?php echo $data['staff_designation_id']; ?>" readonly>
       </div>
       </div>
       ...
       <div class="form-group row " style="margin-bottom:30px ">
       <label for="Expenses details" class="col-sm-2 col-form-label">Date</label>
       <div class="col-sm-3">
       <input style="margin-bottom:30px" type="date" name="date" placeholder="Expenses details" class="form-control mb-2" required value="<?php echo $data['date']; ?>" readonly>
       </div>
       </div>
       <div class="form-group row " style="margin-bottom:30px ">
       ...
       <label for="Expenses details" class="col-sm-3 col-form-label">Out Time</label>
       <div class="col-sm-4">
       ...
       <button onclick="document.getElementById('edit<?php echo $data['id'] ?>').style.display='block'" class="btn btn-warning" style="  margin-left:0px ; margin-top:10px ; margin-bottom:10px "><span class="glyphicon glyphicon-pencil"></span> Edit</button>
       <div id="edit<?php echo $data['id'] ?>" class="modal" >
       <div class="modal-content ">
       <span onclick="document.getElementById('edit<?php echo $data['id'] ?>').style.display='none'"  style="margin-left:870px ; margin-bottom:-40px">&times;</span>
       <span onclick="document.getElementById('edit<?php echo $data['id'] ?>').style.display='none'" class="w3-button w3-display-topright">&times;</span>
       <script>
       window.addEventListener("click", function(event) {
       // Get REFUSE modal
       var modal = document.getElementById('edit<?php echo $data['id'] ?>');
       // When the user clicks anywhere outside of the modal, close it
       if (event.target == modal) {
       modal.style.display = "none";
       }
...
<div align="left" class="w3-container  col-lg-12 w3-text-black card recent-sales row  m-auto card mt-5 card-body w3-text-black" style="margin-top:-1000px ; margin-bottom:10px " id="showcase" >
      ...
      <h1 class="w3-xxxlarge w3-text-black"><b> Edit Attendance Details</b></h1>
      ...
      <nav>
        ...
        <div align="left" class="row col-lg-12 m-auto card mt-5 card-body w3-text-black" style="margin-left:0px ; margin-top:10px ; margin-bottom:0px">
                        ...
                        <?php $db->Store_Record(); ?>
                            ...
                            <form method="POST" action = "edit.php?U_ID=<?php echo $data['id'] ?>" align="left">
                                ...
                                <input style="margin-bottom:30px" type="time" name="outtime" placeholder="In Time" class="form-control mb-2" required value="<?php echo $data['outtime']; ?>" >
                                 ...
                                 <div  style=" margin-left:375px ; margin-top:50px ; margin-bottom:50px">
