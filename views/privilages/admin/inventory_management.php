...
<div class="section dashboard col-xlg  col-12 card " style="margin-left:0px ; margin-top:00px ; margin-bottom:100px ; margin-right:000px">
    ...
    <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul w3-center">
          <a href="http://localhost/test/views/privilages/admin/equipment_purchases/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Equipment Purchases</li></a>
      </ul>
    </div>
        
    <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul  w3-center">
        <a href="http://localhost/test/views/privilages/admin/equipments_in_use/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Equipments In Use</li></a>
     ...
     <div class="w3-third w3-margin-bottom">
      <ul class="w3-ul  w3-center">
         <a href="http://localhost/test/views/privilages/admin/equipments_not_in_use/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Equipments Not In Use</li></a>
    ...
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul w3-blue-green  btn-lg w3-center">
          <a href="http://localhost/test/views/privilages/admin/vendor/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Vendor Details</li></a>
      </ul>
    </div>
