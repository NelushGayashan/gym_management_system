...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">View Equipment Purchases Records</li>
        </ol>
      </nav>
    ...
    <!-- The Modal -->
                ...
                <div class="modal-content ">
                    <span onclick="document.getElementById('add').style.display='none'"  style="margin-left:880px ; margin-bottom:-40px">&times;</span>
                     <span onclick="document.getElementById('add').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                        <?php require_once('C:/xampp/htdocs/test/views/privilages/admin/equipment_purchases/index.php'); ?>
                <script>
		...
		$.ajax({
			data: data,
			type: "post",
			url: "localhost/test/controllers/operations_equipment_purchases.php/Store_Record()",
			success: function(dataResult){
					...
					if(dataResult.statusCode==200){
					   ...
					   alert(dataResult);
                                ...
                                <td style="width: 5%"> Equipment Status </td>
