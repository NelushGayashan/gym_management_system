    ...
    <nav>
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/admin/customer_management.php">Customer Management</a></li>
          ...
          <li class="breadcrumb-item active">Edit Customer Records</li>
        </ol>
      </nav>
        ...
        <div class="row col-lg-12 m-auto card mt-5 card-body w3-text-black" style="margin-left:0px ; margin-top:10px ; margin-bottom:0px">
                        ...
                        <?php $db->Store_Record(); ?>
                            ...
                            <input style="margin-bottom:30px" type="hidden" name="id" placeholder=" Customer ID" class="form-control mb-2" required value="<?php echo $data['id']; ?>">
                                ...
                                <div class="col-sm-4">
                                <input style="margin-bottom:30px" type="text" name="address" placeholder="Address" class="form-control mb-2" required value="<?php echo $data['address']; ?>" >
                                
                                </div>
                                <label for="Telephone Number" class="col-sm-2 col-form-label">Telephone </label>
                                <div class="col-sm-4">
                                <input style="margin-bottom:30px" type="tel"  placeholder="0771231234" pattern="[0-9]{10}" name="telephone" placeholder="Telephone Number" class="form-control mb-2" required value="<?php echo $data['telephone']; ?>" >
                                ...
                                <div class="col-sm-4">
                                <input style="margin-bottom:30px" type="date" name="doj" placeholder="Date Of Joined" class="form-control mb-2" required value="<?php echo $data['doj']; ?>" >
                                </div>
                                </div>
