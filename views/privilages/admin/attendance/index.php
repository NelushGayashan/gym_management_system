        ...
        <div class="row col-lg-12 m-auto card mt-5 card-body w3-text-black" style="margin-left:0px ; margin-top:10px ; margin-bottom:0px">
                        ...
                        <?php $db->Store_Record(); ?>
                             ...
                             <form method="POST" id="user_form">
                                ...
                                <div class="col-sm-4">
                                <input style="margin-bottom:30px" type="time" id="intime" name="intime" placeholder="In Time" class="form-control mb-2" required >
                                </div>
                                <label for="Out Time" class="col-sm-2 col-form-label">Out Time</label>
                                <div class="col-sm-4">
                                <input style="margin-bottom:30px" type="time" id="outtime" name="outtime" placeholder="Out Time" class="form-control mb-2" required >
                       ...
                       <div  style=" margin-left:400px ; margin-top:50px ; margin-bottom:50px ">
                            <button id="myBtn" class="btn btn-success btn-lg" onclick="myFunction()" name="submit" style=" margin-right:5px  "> Save </button>
