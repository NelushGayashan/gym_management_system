...
<!-- Header -->
  <div class="w3-container" style="margin-top:80px ; margin-bottom:80px" id="showcase">
    ...
    <hr style="width:50px;border:5px solid green" class="w3-round">
        ...
        <div class=" row col-lg m-auto card mt card-body table-responsive-lg w3-text-black" style="margin-left:-50px ; margin-top:50px; overflow-x: scroll ;">
                        
             <?php $db->view_record(); ?>

         <form  method="post" style="margin-bottom:40px ;margin-left:900px" >
                
                <select required class="custom-select mr-sm-2 " id="search" name="search" >
                                <option value="" selected>Please Select Customer Name...</option>
                                <option value="Male" selected>Male</option>
                                <option value="Female" selected>Female</option>
                                </select>
                 <button class="btn btn-small btn-primary" name="submit" style=" margin-right:5px  " > Search </button>
        </form>
                 <?php
                              $db->display_message(); 
                              $db->display_message();
                        ?> <div class="scroll card-body card mb-4" style="width:110%">
