...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Equipments Not In Use Details</li>
        </ol>
      </nav>
          ...
          <div class="w3-container  w3-text-black " style="margin-top:0px ; margin-bottom:50px " id="showcase" >
                       <h1 class="w3-large "><b>Equipments Not In Use</b></h1><!-- comment -->
...
?>
          ...
          <div class="w3-container  w3-text-black " style="margin-top:50px ; margin-bottom:50px " id="showcase" >
                       <h1 class="w3-large "><b>Equipments Not In Use By Vendor</b></h1><!-- comment -->
                      ...
                      <table id="Member_Registrations_Per_Month" class=" table table-hover display nowrap" style="width:70%" style="margin-left:200px ;margin-bottom:100px">
                           <thead class="thead-dark w3-large" align = "center" scope="col" style="background-color: #21B6A8; color:#FFF"> <tr>
                                ...
                                <td  style="width: 1%"> # </td>
                                <td style="width: 10%"> Vendor ID </td>
                                <td style="width: 5%"> Vendor Name </td>
                                <td style="width: 5%"> Number Of Equipments </td>
                            ...
                            <tr>
                                <?php 
                                 $i=0;   while($data = mysqli_fetch_assoc($result))
                                    {  $i++;
                                        array_push($xdata,$data['vendor_id']);
                       
                    array_push($ydata,$data['no_of_rows']);
                                ?>
                                
                                    <td style="background-color: #fff; color:#097969"><?php echo $i ?></td>
                                    <td style="background-color: #fff; color:#097969"><?php echo $data['vendor_id'] ?></td>
                                    <td style="background-color: #fff; color:#097969"><?php echo $data['vendor_name'] ?></td>
        ...
        export: {
          csv: {
            filename: "Equipments Not In Use By Vendor",
            columnDelimiter: ',',
                   ...
                   $(document).ready(function() {
                    $('#Member_Registrations_Per_Month').DataTable( {
                        ...
                        buttons: [
                                    {
                                        extend: 'copyHtml5',
                                        title: 'Equipments Not In Use By Vendor'
                                    },
                                    {
                                        extend: 'csvHtml5',
                                        title: 'Equipments Not In Use By Vendor'
