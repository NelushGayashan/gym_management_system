    ...
    class  operations_schedule_details extends dbconfig
    {
        ...
        public function Store_Record()
        {
            ...
            if(isset($_POST['btn_save']))
            {
                ...
                if($this->insert_record($id,$given_date,$renew_date,$exercises,$remarks))
                {
        ...
        function insert_record($id,$given_date,$renew_date,$exercises,$remarks)
        {
            global $db;
            $query = "insert into schedule_details (id,given_date,renew_date,exercises,remarks) values('$id','$given_date','$renew_date','$exercises','$remarks')";
        ...
        public function update()
        {
            ...
            if(isset($_POST['btn_update']))
            {
                ...
                if($this->update_record($id,$given_date,$renew_date,$exercises,$remarks))
                {
        ...
        // Update Function 2
        public function update_record($id,$given_date,$renew_date,$exercises,$remarks)
        {
            global $db;
            $sql = "update schedule_details set given_date='$given_date', renew_date='$renew_date',exercises = '$exercises', remarks='$remarks' where ID='$id'";
