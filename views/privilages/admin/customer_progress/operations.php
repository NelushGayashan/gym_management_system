    ...
    class  operations_customer_progress extends dbconfig
    {
        ...
        public function Store_Record()
        {
            ...
            if(isset($_POST['btn_save']))
            {
                ...
                if($this->insert_record($id,$progress_details,$schedule_Details_id))
                {
        ...
        function insert_record($id,$progress_details,$schedule_Details_id)
        {
            global $db;
            $query = "insert into customer_progress (id,progress_details,schedule_Details_id) values('$id','$progress_details','$schedule_Details_id')";
        ...
        {
            global $db;
            $query = "select * from customer_progress";
            $result = mysqli_query($db->connection,$query);
            return $result;
        }
        ...
        public function update()
        {
            ...
            if(isset($_POST['btn_update']))
            {
                ...
                if($this->update_record($id,$progress_details,$schedule_Details_id))
                {
        ...
        // Update Function 2
        public function update_record($id,$progress_details,$schedule_Details_id)
        {
            global $db;
            $sql = "update customer_progress set progress_details='$progress_details', schedule_Details_id='$schedule_Details_id' where ID='$id'";
