...
<!-- Header -->
  <div class="w3-container  w3-text-black card recent-sales" style="margin-top:50px ; margin-bottom:20px " id="showcase" >
    <h1 class="w3-xxlarge "><b>View Membership Details</b></h1>
...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/admin/customer_management.php">Customer Management</a></li>
          <li class="breadcrumb-item active">View Membership Details</a></li>
    ...
    <!-- The Modal -->
                ...
                <div class="modal-content ">
                    <span onclick="document.getElementById('add').style.display='none'"  style="margin-left:880px ; margin-bottom:-40px">&times;</span>
                     <span onclick="document.getElementById('add').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                        <?php require_once('C:/xampp/htdocs/test/views/privilages/admin/membership/index.php'); ?>
                <script>
		...
		$.ajax({
			data: data,
			type: "post",
			url: "localhost/test/controllers/operations_membership.php/Store_Record()",
			success: function(dataResult){
					...
					if(dataResult.statusCode==200){
					   ...
					   alert(dataResult);
                                ...
                                <td style="width: 10%"> Membership ID </td>
                                <td style="width: 5%"> Membership Name </td>
                                <td style="width: 20%"> Membership Description </td>
				<td style="width: 10%"> Membership Fee </td>
       ...
       <label for="Expenses details" class="col-sm-3 col-form-label">Membership Name</label>
       <div class="col-sm-9">
       ...
       <div class="form-group row " style="margin-bottom:30px ">
       <label for="Expenses details" class="col-sm-2 col-form-label">Description</label>
       <div class="col-sm-10">
       <input style="margin-bottom:30px" type="text" name="details" placeholder="Description" class="form-control mb-2" required value="<?php echo $data['description']; ?>" readonly>
       </div>
       </div>
       <div class="form-group row " style="margin-bottom:30px ; margin-top:30px">
       <label for="Expenses details" class="col-sm-3 col-form-label">Membership Fee</label>
       <div class="col-sm-3">
       <input style="margin-bottom:30px" type="text" name="details" placeholder="Membership Fee" class="form-control mb-2" required value="<?php echo $data['fee']; ?>" readonly>
       </div>
       </div>
       </div>    
       <!-- End page content -->
        ...
        $(document).ready(function () {
            ...
            $('.viewbtn').on('click', function () {
                ...
                $.ajax({ //create an ajax request to display.php
                    type: "POST",
                    url: "localhost/test/controllers/operations_membership.php/view_record()",
