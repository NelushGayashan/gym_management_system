    ...
    class  operations_income extends dbconfig
    {
        ...
        public function Store_Record()
        {
            ...
            if(isset($_POST['btn_save']))
            {
                ...
                if($this->insert_record($id,$amount,$date,$remark))
                {
        ...
        function insert_record($id,$amount,$date,$remark)
        {
            global $db;
            $query = "insert into income (id,amount,date,remark) values('$id','$amount','$date','$remark')";
        ...
        public function update()
        {
            ...
            if(isset($_POST['btn_update']))
            {
                ...
                if($this->update_record($id,$amount,$date,$remark))
                {
        ...
        // Update Function 2
        public function update_record($id,$amount,$date,$remark)
        {
            global $db;
            $sql = "update income set amount='$amount', date='$date',remark = '$remark' where ID='$id'";
