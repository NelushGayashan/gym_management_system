...
<!-- Header -->
  <div class="w3-container  w3-text-black card recent-sales row col-lg-12 m-auto card mt-5 card-body w3-text-black" style="margin-top:-1000px ; margin-bottom:10px " id="showcase" >
      ...
      <h1 class="w3-xxlarge "><b>Add Income Details</b></h1>
 ...
 <nav>
       <ol class="breadcrumb">
         ...
         <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/admin/expenses_income_management.php">Expense And Income Management</a></li>
          ...
          <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/admin/income/view.php">View Income Details</a></li>
        ...
        <div class="row col-lg-12 m-auto card mt-5 card-body w3-text-black" style="margin-left:0px ; margin-top:10px ; margin-bottom:0px">
                        ...
                        <?php $db->Store_Record(); ?>
                             ...
                             <form method="POST" id="user_form">
                                ...
                                <input style="margin-bottom:30px" type="hidden" name="id" placeholder="Income ID" class="form-control mb-2" required>
                                ...
                                <option value="">Please Select Membership Payment.....</option>
                                <?php
                                ...
                                <option value="">Please Select Salary Payment.....</option>
                                <?php
                                $con = mysqli_connect("localhost","root","","fitness_for_everyone");
                                ...
                                <option value="">Please Select Equipment Expenses.....</option>
                                <?php
                                $con = mysqli_connect("localhost","root","","fitness_for_everyone");
