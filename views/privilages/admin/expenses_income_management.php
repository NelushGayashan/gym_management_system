...
<div class="section dashboard col-xlg  col-12 card " style="margin-left:0px ; margin-top:00px ; margin-bottom:100px ; margin-right:000px">
    ...
    <div class="w3-half w3-margin-bottom">
      <ul class="w3-ul w3-center">
          <a href="http://localhost/test/views/privilages/admin/expenses/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Expenses</li></a>
      </ul>
    </div>
        
    <div class="w3-half w3-margin-bottom">
      <ul class="w3-ul w3-light-grey w3-center">
        <a href="http://localhost/test/views/privilages/admin/outstanding/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Outstanding</li></a>
    ...
    <div class="w3-half w3-margin-bottom">
      <ul class="w3-ul  w3-center">
          <a href="http://localhost/test/views/privilages/admin/income/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Income</li></a>
      </ul>
    </div>
         ...
         <div class="w3-half w3-margin-bottom">
      <ul class="w3-ul  w3-center">
         <a href="http://localhost/test/views/privilages/admin/payment/view.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Payment</li></a>
