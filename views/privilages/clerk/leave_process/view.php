...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Leave Process Records</li>
        </ol>
      </nav>
       ...
       <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/clerk/dashboard.php">Staff Management</a></li>
          <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/clerk/leave_process/view.php">View Leave Process Details</a></li>
        ...
        $(document).ready(function () {
            ...
            $('.viewbtn').on('click', function () {
                ...
                $.ajax({ //create an ajax request to display.php
                    type: "POST",
                    url: "localhost/test/controllers/operations_leave_process.php/view_record()",
