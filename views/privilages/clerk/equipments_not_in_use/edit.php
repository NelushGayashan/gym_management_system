<?php 
        require_once('C:/xampp/htdocs/test/controllers/operations_equipments_not_in_use.php');  
    $db = new  operations_equipments_not_in_use();
    $db->update();
    $id = $_GET['U_ID'];
...
<head>
    <title>Edit Equipments Not In Use Details</title>
</head>
<!-- Header -->
  <div class="w3-container" style="margin-top:80px ; margin-bottom:80px" id="showcase">
    <h1 class="w3-xxxlarge w3-text-black"><b>Edit Equipments Not In Use Details</b></h1>
