...
?>
<head>
  <title>Equipments In Use Details</title>  
</head>
<!-- Header -->
...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Equipments In Use Details</li>
        </ol>
      </nav>
          ...
          <div class="w3-container  w3-text-black " style="margin-top:0px ; margin-bottom:50px " id="showcase" >
                       <h1 class="w3-large "><b>Equipments In Use</b></h1><!-- comment -->
                       ...
                       <table id="Member_Registrations" class=" table table-hover display nowrap">
                           <thead class="thead-dark w3-large" align = "center" scope="col" style="background-color: #21B6A8; color:#FFF"> <tr>
                                ...
                                <td  style="width: 1%"> # </td>
                                <td style="width: 5%"> Equipment Name </td>
...
?>
          ...
          <div class="w3-container  w3-text-black " style="margin-top:50px ; margin-bottom:50px " id="showcase" >
                       <h1 class="w3-large "><b>Equipments In Use By Vendor</b></h1><!-- comment -->
        ...
        export: {
          csv: {
            filename: "Equipments In Use By Vendor",
            columnDelimiter: ',',
                   ...
                   $(document).ready(function() {
                    $('#Member_Registrations_Per_Month').DataTable( {
                        ...
                        buttons: [
                                    {
                                        extend: 'copyHtml5',
                                        title: 'Equipments In Use By Vendor'
                                    },
                                    {
                                        extend: 'csvHtml5',
                                        title: 'Equipments In Use By Vendor'
