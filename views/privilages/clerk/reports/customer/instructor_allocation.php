...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">All Instructor Allocation Details</li>
        </ol>
      </nav>
               ...
               <div class="card-body row col-lg m-auto card mt card-body table-responsive-lg w3-text-black " style="  margin-left:-50px ; margin-top:50px ; margin-bottom:0px ">
                       ...
                       <table id="Member_Registrations" class=" table table-hover display nowrap">
                           <thead class="thead-dark w3-large" align = "center" scope="col" style="background-color: #21B6A8; color:#FFF"> <tr>
                                ...
                                <td style="width: 5%"> Staff Member Name </td>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td style="background-color: #fff; color:#097969"><?php echo $data['customer_id'] ?></td>
               ...
               <?php
                  ...
                  $ydata=array();
                    ...
                    while($data = mysqli_fetch_assoc($result)){
                        ...
                        array_push($xdata,$data['staff_id']);
                ...
                <h1 class="w3-large w3-text-black"><b>Instructor Allocation</b></h1></div> 
