...
?>
<head>
  <title>All Customer Registrations Details</title>  
</head>
<!-- Header -->
  <div class="w3-container  w3-text-black card recent-sales" style="margin-top:50px ; margin-bottom:20px " id="showcase" >
    <h1 class="w3-xxlarge "><b>All Customer Registrations Details</b></h1>
...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">All Customer Registrations Details</li>
        </ol>
      </nav>
               ...
               <div class="card-body row col-lg m-auto card mt card-body table-responsive-lg w3-text-black " style="  margin-left:-50px ; margin-top:50px ; margin-bottom:0px ">
                       ...
                       <table id="Member_Registrations" class=" table table-hover display nowrap">
                           <thead class="thead-dark w3-large" align = "center" scope="col" style="background-color: #21B6A8; color:#FFF"> <tr>
                                ...
                                <td  style="width: 1%"> # </td>
                                <td  style="width: 2%"> Registration Date </td>
                                <td  style="width: 2%"> Registration Fee </td>
                                <td  style="width: 2%"> Membership ID </td>
                                <td  style="width: 2%"> Payment ID </td>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td  style="background-color: #fff; color:#097969"><?php echo number_format($data['reg_fee'],2) ?></td>
                                    <td  style="background-color: #fff; color:#097969"><?php echo $data['membership_id'] ?></td>
                                    <td  style="background-color: #fff; color:#097969"><?php echo $data['membership_payment_id'] ?></td>
               ...
               <?php
                ...
                <h1 class="w3-large w3-text-black"><b>Member Registrations</b></h1></div> 
               ...
               <table id="Member_Registrations_Per_Month" class=" table table-hover display nowrap" style="width:50%" style="margin-left:200px ;margin-bottom:100px">
                           <thead class="thead-dark w3-large" align = "center" scope="col" style="background-color: #21B6A8; color:#FFF"> <tr>
                                ...
                                <td style="width: 5%"> Member Registration Count </td>
