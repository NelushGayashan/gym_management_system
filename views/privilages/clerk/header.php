      ...
      <ul class="nav navbar-nav navbar-right " style="margin-left: 825px ">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
              ...
              <li>
              <a class="dropdown-item d-flex align-items-center w3-light-green12 w3-text-black" href="http://localhost/test/views/privilages/clerk/edit.php?U_ID=<?php echo $_SESSION['id'];  ?>">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"  href="http://localhost/test/views/privilages/clerk/useraccount/view.php">
          ...
          <span>User Administration</span>
           ...
           <li class="nav-item">
        <a class="nav-link collapsed"  href="http://localhost/test/views/privilages/clerk/reports.php">
