...
<!-- Header -->
  <div class="w3-container  w3-text-black card recent-sales" style="margin-top:50px ; margin-bottom:20px " id="showcase" >
    <h1 class="w3-xxlarge "><b>View Expenses Details</b></h1>
...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/clerk/expenses_income_management.php">Expense And Income Management</a></li>
            ...
            <li class="breadcrumb-item active">View Expenses Details</a></li>
    ...
    <!-- The Modal -->
                ...
                <div class="modal-content ">
                    <span onclick="document.getElementById('add').style.display='none'"  style="margin-left:880px ; margin-bottom:-40px">&times;</span>
                     <span onclick="document.getElementById('add').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                        <?php require_once('C:/xampp/htdocs/test/views/privilages/clerk/expenses/index.php'); ?>
                <script>
		...
		$.ajax({
			data: data,
			type: "post",
			url: "localhost/test/controllers/operations_expenses.php/Store_Record()",
			success: function(dataResult){
					...
					if(dataResult.statusCode==200){
					   ...
					   alert(dataResult);
                                ...
                                <td style="width: 15%"> Expenses details </td>
                                <td style="width: 5%"> Amount </td>
                                <td style="width: 5%"> Payment ID </td>
                                <td style="width: 5%"> Payment Type ID </td>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td><?php echo $data['payment_payment_type_id'] ?></td>
       ...
       <li class="breadcrumb-item"><a href="http://localhost/test/views/privilages/clerk/dashboard.php">Dashboard</a></li>
       <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/clerk/expenses_income_management.php">Expense And Income Management</a></li>
          <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/clerk/expenses/view.php">View Payment Details</a></li>
       ...
       <label for="Expenses details" class="col-sm-2 col-form-label">Expense ID</label>
       <div class="col-sm-2">
       ...
       <label for="Expenses details" class="col-sm-2 col-form-label">Amount</label>
       <div class="col-sm-2">
       <input style="margin-bottom:30px" type="number" name="details" placeholder="Expenses details" class="form-control mb-2" required value="<?php echo $data['amount']; ?>" readonly>
       </div>
       </div>
       <div class="form-group row " style="margin-bottom:30px ">
       <label for="Expenses details" class="col-sm-2 col-form-label">Details</label>
       <div class="col-sm-10">
       <input style="margin-bottom:30px" type="text" name="details" placeholder="Details" class="form-control mb-2" required value="<?php echo $data['details']; ?>" readonly>
       </div>
       </div>
       <div class="form-group row " style="margin-bottom:30px ">
        ...
        $(document).ready(function () {
            ...
            $('.viewbtn').on('click', function () {
                ...
                $.ajax({ //create an ajax request to display.php
                    type: "POST",
                    url: "localhost/test/controllers/operations_expenses.php/view_record()",
