...
<!-- Header -->
  <div class="w3-container  w3-text-black card recent-sales" style="margin-top:50px ; margin-bottom:20px " id="showcase" >
    <h1 class="w3-xxlarge "><b>View Staff Details</b></h1>
...
<div class="pagetitle">
    ...
    <!-- The Modal -->
                ...
                <div class="modal-content ">
                    <span onclick="document.getElementById('add').style.display='none'"  style="margin-left:880px ; margin-bottom:-40px">&times;</span>
                     <span onclick="document.getElementById('add').style.display='none'" class="w3-button w3-display-topright">&times;</span>
                        <?php require_once('C:/xampp/htdocs/test/views/privilages/clerk/staff/index.php'); ?>
                <script>
		...
		$.ajax({
			data: data,
			type: "post",
			url: "localhost/test/controllers/operations_staff.php/Store_Record()",
			success: function(dataResult){
					...
					if(dataResult.statusCode==200){
					   ...
					   alert(dataResult);
                                ...
                                <td style="width: 5%"> Staff Member ID </td>
                                <td style="width: 5%"> Staff Member's First Name </td>
                                <td style="width: 5%"> Staff Member's Last Name </td>
                                ...
                                <td style="width: 5%"> Designation ID </td>
					...
					<td style="width: 5%" colspan="2" >Operations</td>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td><?php echo $data['useraccount_role_id'] ?></td>
      ...
      <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/clerk/dashboard.php">Staff Management</a></li>
          <li class="breadcrumb-item "><a href="http://localhost/test/views/privilages/clerk/staff/view.php">View Staff Details</a></li>
       ...
       <div class="form-group row" style="margin-bottom:30px ; margin-top:30px">
                                <label for="Email" class="col-sm-2 col-form-label">Staff ID</label>
                                <div class="col-sm-3">
                                ...
                                <label for="Staff Member First Name" class="col-sm-2 col-form-label ">First Name</label>
                                <div class="col-sm-3">
                                ...
                                <label for="Staff Member Last Name" class="col-sm-2 col-form-label ">Last Name</label>
                                <div class="col-sm-3">
        ...
        $(document).ready(function () {
            ...
            $('.viewbtn').on('click', function () {
                ...
                $.ajax({ //create an ajax request to display.php
                    type: "POST",
                    url: "localhost/test/controllers/operations_staff.php/view_record()",
