...
<div class="section dashboard col-xlg  col-12 card " style="margin-left:0px ; margin-top:00px ; margin-bottom:100px ; margin-right:000px">
    ...
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
          <a href="http://localhost/test/views/privilages/clerk/customer/view.php" ><li class="w3-blue-green  btn-lg w3-xlarge w3-padding-32">Customer<br>&#8205;</li></a>
      </ul>
    </div>
        
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
        <a href="http://localhost/test/views/privilages/clerk/customer_details/view.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Customer<br>Details</li></a>
     ...
     <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
         <a href="http://localhost/test/views/privilages/clerk/schedule_details/view.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Schedule<br>Details</li></a>
    ...
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
        <a href="http://localhost/test/views/privilages/clerk/membership/view.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Membership<br>Plans</li></a>
    ...
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
        <a href="http://localhost/test/views/privilages/clerk/register/view.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Registration<br>&#8205;</li></a>
