      ...
      <ul class="nav navbar-nav navbar-right " style="margin-left: 825px ">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
              ...
              <li>
              <a class="dropdown-item d-flex align-items-center w3-light-green12 w3-text-black" href="http://localhost/test/views/privilages/customer/edit.php?U_ID=<?php echo $_SESSION['id'];  ?>">
...
<nav class="w3-sidebar w3-light-green w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:280px;font-weight:bold;position: fixed;" id="mySidebar"><br>
  ...
  <ul class="sidebar-nav " id="sidebar-nav" >
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="http://localhost/test/views/privilages/customer/dashboard.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"  href="http://localhost/test/views/privilages/customer/customer_details/view.php">
        <i class="bi bi-heart-fill"></i>
            <span>Fitness Info</span>
         
        </a>
      </li>

      <li class="nav-item">
        <a class="nav-link collapsed"  href="http://localhost/test/views/privilages/customer/schedule_details/view.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"  href="http://localhost/test/views/privilages/customer/customer_progress/view.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"  href="http://localhost/test/views/privilages/customer/register/view.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"  href="http://localhost/test/views/privilages/customer/membership/view.php">
