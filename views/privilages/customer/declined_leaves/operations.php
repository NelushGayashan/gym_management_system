<?php 
    ...
    class  operations_declined_leaves extends dbconfig
    {
        ...
        {
            global $db;
            $query = "insert into declined_leaves (id,leave_process_id,staff_id,staff_member_name, remark) values('$id','$leave_process_id','$staff_id','$staff_member_name','$remark')";
        ...
        {
            global $db;
            $query = "select * from declined_leaves";
            $result = mysqli_query($db->connection,$query);
            return $result;
        }
        ...
        {
            global $db;
            $sql = "select * from declined_leaves where ID='$id'";
        ...
        {
            global $db;
            $sql = "update declined_leaves set leave_process_id='$leave_process_id', staff_id='$staff_id',staff_member_name = '$staff_member_name', remark='$remark' where ID='$id'";
        ...
        {
            global $db;
            $query = "delete from declined_leaves where ID='$id'";
            $result = mysqli_query($db->connection,$query);
            if($result)
            {
                return true;
