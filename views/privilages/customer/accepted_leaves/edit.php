<?php 
    require_once('C:/xampp/htdocs/test/controllers/operations_accepted_leaves.php'); 
    $db = new  operations_accepted_leaves();
    $db->update();
    $id = $_GET['U_ID'];
...
<head>
    <title>Edit Accepted Leaves Details</title>
</head>
<!-- Header -->
  <div class="w3-container  col-lg-12 w3-text-black card recent-sales row  m-auto card mt-5 card-body w3-text-black" style="margin-top:-1000px ; margin-bottom:10px " id="showcase" >
    ...
    <h1 class="w3-xxxlarge w3-text-black"><b>Edit Accepted Leaves Details</b></h1>
...
<div class="pagetitle col-lg-12"  style="margin-top:10px ; margin-bottom:-50px; margin-left:0px ">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="http://localhost/test/views/privilages/admin/dashboard.php">View Leave Details</a></li>
          <li class="breadcrumb-item active">Edit Accepted Leaves Details</li>
        </ol>
      </nav>
