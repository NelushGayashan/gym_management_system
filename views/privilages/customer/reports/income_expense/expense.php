...
<div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Overall Expense Payments</li>
        </ol>
      </nav>
                           ...
                           <thead class="thead-dark w3-large" align = "center" scope="col" style="background-color: #21B6A8; color:#FFF"> <tr>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td  style="background-color: #fff; color:#097969"><?php echo $data['details'] ?></td>
...
?>
                ...
                <h1 class="w3-large w3-text-black"><b>Expenses By Month</b></h1></div> </div> 
                    ...
                    <table id="Member_Registrations_Per_Month" class=" table table-hover display nowrap" style="width:50%" style="margin-left:200px ;margin-bottom:100px">
                           <thead class="thead-dark w3-large" align = "center" scope="col" style="background-color: #21B6A8; color:#FFF"> <tr>
                                ...
                                <td  style="width: 1%"> # </td>
                                <td style="width: 5%"> Year-Mont </td>
                                <td style="width: 5%"> Total Amount For Expenses</td>
                            ...
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td  style="background-color: #fff; color:#097969"><?php echo number_format($data['SUM'],2) ?></td>
   ...
   $db = new  operations_expenses();
    $result=$db->view1_record();
               ...
               <div class="card-body">
                <div class="w3-container" style="margin-top:50px ; margin-bottom:0px" id="showcase">
                <h1 class="w3-medium w3-text-black"><b>Expenses By Month</b></h1></div> </div> 
               <div id="chart"></div>
                   ...
                   $(document).ready(function() {
                    $('#Member_Registrations').DataTable( {
                        ...
                        buttons: [
                                    {
                                        extend: 'copyHtml5',
                                        title: 'Overall Expense Payments'
                                    },
                                    {
                                        extend: 'csvHtml5',
                                        title: 'Overall Expense Payments'
