...
<head>
    <title>Edit Gender Details</title>
</head>
<!-- Header -->
        ...
        <div class=" row col-lg-6 m-auto card mt-5 card-body w3-text-black" style="margin-left:100px ; margin-top:0px ; margin-bottom:100px">
                        ...
                        <?php $db->Store_Record(); ?>
                            ...
                            <form method="POST">
                                ...
                                <label style="margin-bottom:10px" class = "card-footer">Gender</label>
                                <input style="margin-bottom:30px" type="text" name="gender" placeholder="Gender Name" class="form-control mb-2" required value="<?php echo $data['gender']; ?>">
