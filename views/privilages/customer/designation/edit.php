...
<!-- Header -->
  <div class="w3-container" style="margin-top:80px ; margin-bottom:80px" id="showcase">
    <h1 class="w3-xxxlarge w3-text-black"><b>Edit Gender Details</b></h1>
        ...
        <div class=" row col-lg-6 m-auto card mt-5 card-body w3-text-black" style="margin-left:100px ; margin-top:0px ; margin-bottom:100px">
                        ...
                        <?php $db->Store_Record(); ?>
                            ...
                            <form method="POST">
                                ...
                                <input style="margin-bottom:30px" type="hidden" name="id" placeholder="Designation ID" class="form-control mb-2" required value="<?php echo $data['id']; ?>">
                                
                                <label style="margin-bottom:10px" class = "card-footer">Designation</label>
                                <input style="margin-bottom:30px" type="text" name="name" placeholder="Designation Name" class="form-control mb-2" required value="<?php echo $data['name']; ?>">
