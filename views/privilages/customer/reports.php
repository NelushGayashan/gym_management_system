...
<div class="section dashboard col-xlg  col-12 card " style="margin-left:0px ; margin-top:00px ; margin-bottom:100px ; margin-right:000px">
    ...
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
        <a href="http://localhost/test/views/privilages/clerk/reports/customer/members.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">All Customers</li></a>
    ...
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
        <a href="http://localhost/test/views/privilages/clerk/reports/customer/register.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Registration</li></a>
     ...
     <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
         <a href="http://localhost/test/views/privilages/clerk/reports/customer/membership_register.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Membership Registration</li></a>
         ...
         <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
         <a href="http://localhost/test/views/privilages/clerk/reports/customer/instructor_allocation.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Instructor Allocation</li></a>
     ...
     <div class="w3-row-padding" style="margin-left:20px ; margin-top:50px ; margin-bottom:50px">
         ...
         <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
         <a href="http://localhost/test/views/privilages/clerk/reports/income_expense/membership_payment.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Membership Payment</li></a>
    ...
    <div class="w3-quarter w3-margin-bottom">
      <ul class="w3-ul  w3-center">
        <a href="http://localhost/test/views/privilages/clerk/reports/income_expense/expense.php" ><li class="w3-blue-green btn-lg w3-xlarge w3-padding-32">Expense Handling</li></a>
