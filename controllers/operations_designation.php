<?php 
    ...
    class  operations_designation extends dbconfig
    {
        ...
        public function insert_record($id,$name)
        {
            global $db;
            $query = "insert into designation (id,name) values('$id','$name')";
