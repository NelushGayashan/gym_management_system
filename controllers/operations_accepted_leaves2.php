<?php 
    ...
    class  operations_accepted_leaves2 extends dbconfig
    {
        ...
        function insert_record($id,$leave_process_id,$staff_id,$staff_member_name,$remark,$date)
        {
            global $db;
        ...
        {
            global $db;
            $query = "SELECT date AS date, COUNT(id) AS no_of_rows FROM accepted_leaves GROUP BY date  ORDER BY date;";
            $result = mysqli_query($db->connection,$query);
            return $result;
        }
